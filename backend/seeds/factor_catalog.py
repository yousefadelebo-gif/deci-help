"""Factor category and template catalog for seeding."""

CATEGORIES_DATA = [
    {'name': 'Financial', 'description': 'Money and cost-related factors', 'icon': 'attach_money', 'color': '#4CAF50', 'order': 1},
    {'name': 'Time', 'description': 'Time and schedule-related factors', 'icon': 'schedule', 'color': '#2196F3', 'order': 2},
    {'name': 'Career', 'description': 'Professional and career growth factors', 'icon': 'work', 'color': '#9C27B0', 'order': 3},
    {'name': 'Personal', 'description': 'Personal well-being and lifestyle factors', 'icon': 'person', 'color': '#FF9800', 'order': 4},
    {'name': 'Relationships', 'description': 'Family, friends, and social factors', 'icon': 'people', 'color': '#E91E63', 'order': 5},
    {'name': 'Risk', 'description': 'Risk and security factors', 'icon': 'security', 'color': '#F44336', 'order': 6},
    {'name': 'Health', 'description': 'Physical and mental health factors', 'icon': 'favorite', 'color': '#00BCD4', 'order': 7},
    {'name': 'Values', 'description': 'Personal values and ethics', 'icon': 'star', 'color': '#FFC107', 'order': 8},
]
