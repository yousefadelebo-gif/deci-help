"""
Django settings for decision_companion project.
...
ROOT_URLCONF = 'decision_companion.urls'
...
WSGI_APPLICATION = 'decision_companion.wsgi.application'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:3000",
    "http://127.0.0.1:8000",
    # Add your Flutter app origins here
]
